        ...
        <nav className="fixed top-0 w-full z-50 glass-nav">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <a className="hover:bg-white hover:text-black hover:scale-105 hover:font-bold flex bg-primary/10 border items-center border-primary/50 text-primary hover:bg-primary hover:text-background-dark px-5 py-2 rounded-lg text-sm font-bold transition-all duration-300 uppercase tracking-tighter"
                    download
                    href="/cv.pdf">
